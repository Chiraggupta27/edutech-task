...
import { loginFormReady } from "../utils/authValidation.js";
...
export default function Login() {
  ...
  const watched = watch();
  const submitEnabled = loginFormReady(watched);
        ...
        >
          ...
          <div className="authActions">
            <div className="muted authSmall">
              New here? <Link className="authLink" to="/register">Create account</Link>
            </div>
            <button
              type="submit"
